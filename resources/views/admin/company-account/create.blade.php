...
@section('content')
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <form action="{{ route('admin.company-accounts.store') }}" method="POST" class="needs-validation" novalidate>
                    @csrf
                    <div class="card-body">
                        <div class="row">
                            <div class="col-4">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="number" name="starting_balance" id="starting_balance" class="form-control"
                                            value="{{ old('starting_balance') }}" placeholder="Enter Amount" aria-label="Amount"
