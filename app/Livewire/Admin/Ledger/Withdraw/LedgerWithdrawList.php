...
namespace App\Livewire\Admin\Ledger\Withdraw;
...
class LedgerWithdrawList extends Component
{
    use WithPagination;
    ...
    public function render()
    {
        ...
        $ledgers = $query->where('withdraw', '!=', 0)
            ->where('deposit', '=', 0)
            ->orderBy('id', 'asc')
            ->paginate($this->perPage);

        return view('livewire.admin.ledger.withdraw.ledger-withdraw-list', [
            'ledgers' => $ledgers
        ]);
    }
